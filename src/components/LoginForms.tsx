    ...
    <div className='bg-white h-screen flex flex-col justify-center text-center'>
        ...
        <div className="hidden lg:block lg:w-1/2 bg-cover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1546514714-df0ccc50d7bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80')`}}></div>
            <div className="w-full p-8 lg:w-1/2">
                ...
                <a href="/" className="flex items-center justify-center mt-4 bg-black text-white rounded-lg shadow-md hover:bg-gray-100">
                    <div className="px-4 py-3">
                        <h1 className="w-5/6 text-center text-white font-bold text-3xl"></h1>
                    </div>
                    <h1 className="px-4 py-3 w-5/6 text-center text-white font-bold">Sign in with Apple</h1>
                </a>
